...
class Location_Grid_Public_Porch_Chart_Template extends DT_Metrics_Chart_Base
{
    public $base_slug = 'location-grid-public-porch-metrics'; // lowercase
    public $base_title = "Location Grid Public Porch Metrics";
