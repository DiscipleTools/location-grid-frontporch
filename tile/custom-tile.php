...
class Location_Grid_Public_Porch_Tile
{
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = "" ) {
        if ( $post_type === "contacts" ){
            $tiles["location_grid_public_porch"] = [ "label" => __( "Location Grid Public Porch", 'disciple_tools' ) ];
        }
        return $tiles;
    }
    ...
    public function dt_custom_fields( array $fields, string $post_type = "" ) {
        ...
        if ( $post_type === "contacts" ){
             ...
             */
            $fields["location_grid_public_porch_keyselect"] = [
                'name' => "Key Select",
                'type' => 'key_select',
                "tile" => "location_grid_public_porch",
                'default' => [
    ...
    public function dt_add_section( $section, $post_type ) {
         ...
         */
        if ( $post_type === "contacts" && $section === "location_grid_public_porch" ){
            /**
...
Location_Grid_Public_Porch_Tile::instance();
